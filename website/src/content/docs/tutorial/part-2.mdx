...
```typescript twoslash ins={5,13} errorReplace='.*::Type 'R2BucketBinding' is not assignable to type 'WorkerServices | PlatformServices'.'
// @errors: 2345
// @noEmit: true
...
```typescript twoslash ins={9} errorReplace='.*::Type 'R2Error' is not assignable to type 'HttpServerError | HttpBodyError'.'
// @noEmit: true
// @allowImportingTsExtensions: true
// @filename: bucket.ts
import * as Cloudflare from "alchemy/Cloudflare";
...
```typescript twoslash ins={11-16} errorReplace=".*::Type 'R2Error' is not assignable to type 'HttpServerError | HttpBodyError'."
// @errors: 2345
// @noEmit: true
// @allowImportingTsExtensions: true
// @filename: bucket.ts
