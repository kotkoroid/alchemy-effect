...
<Section padding="72px 32px 40px" class="alc-hero">
  ...
  >
    ...
    <source src="/video/hero-bg.mov" type='video/mp4; codecs="hvc1"' />
  </video>
  <div style="position:relative;z-index:1;text-align:center;margin-bottom:24px;">
    <BetaBadge />
  </div>
  <div class="alc-hero__inner">
    <div class="alc-hero__mark" aria-hidden="true">
      {/* Downward water-triangle inscribed in a circle — the
          Sri-Yantra-style descending triangle, also the alchemical
          mark for water / dissolution. Used as a frontispiece glyph. */}
      <svg width="42" height="42" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="miter" stroke-miterlimit="6">
        <circle cx="12" cy="12" r="9.5" />
        {/* Equilateral triangle inscribed in the circle (apex down):
            apex at (12, 12 + r), top vertices at (12 ± r·cos30°, 12 - r·sin30°).
            Centroid coincides with the circle center, so the dot sits at (12,12). */}
        <path d="M12 21.5 L3.77 7.25 L20.23 7.25 Z" />
        <circle cx="12" cy="12" r="1.1" fill="var(--alc-accent-deep)" stroke="none" />
      </svg>
    </div>
...
<Section padding="40px 32px 96px" id="plan-deploy-destroy">
  <div style="text-align:center;margin-bottom:36px;">
    ...
    <h2 class="alc-h2" style="margin:10px 0 12px;"><HeadingOrnament variant="sulphur" position="prefix" />Stand up infrastructure. <span style="color:var(--alc-accent-deep);font-style:italic;">Tear it down just as fast.</span></h2>
...
<Section padding="56px 32px 64px" id="outro">
  ...
  <div class="alc-cta" style="margin-top:48px;text-align:center;">
    <h2 class="alc-h2"><HeadingOrnament variant="fleuron" position="prefix" />Paste this into your coding agent <span style="color:var(--alc-accent-deep);font-style:italic;">to get started</span>.</h2>
