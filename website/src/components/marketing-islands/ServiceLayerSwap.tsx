    ...
    <div ref={wrapRef} className="service-swap-grid">
      ...
      <div className="alc-code-block">
        ...
        <pre className="alc-code-block__pre">
          ...
          <T>Sessions</T>, {"{"}
          {"\n  "}
          <V>get</V>: (<V>id</V>: <T>string</T>) {"=>"} <V>Effect</V>.<T>Effect</T>{"<"}<T>Session</T>{">"};
          {"\n  "}
          <V>put</V>: (<V>s</V>: <T>Session</T>) {"=>"} <V>Effect</V>.<T>Effect</T>{"<"}<T>void</T>{">"};
          {"\n"}
          {"}>()("}<S>"Sessions"</S>{") {}"}
          {"\n\n"}
        ...
        <div className="service-swap-stage__node service-swap-stage__node--accent">
          <svg width="22" height="22" viewBox="0 0 32 32" fill="none" aria-hidden>
            <rect x="4" y="6" width="24" height="20" rx="4"
                  ...
                  stroke="var(--alc-accent-deep)" strokeWidth="1.5" />
        ...
        >
          <svg width="22" height="22" viewBox="0 0 32 32" fill="none" aria-hidden>
            <path d="M16 4 L28 10 L16 16 L4 10 Z"
                  fill={tint(active.color, 0.18)} stroke={active.color}
                  strokeWidth="1.4" strokeLinejoin="round" />
            <path d="M4 16 L16 22 L28 16"
                  stroke={active.color} strokeWidth="1.4" fill="none"
                  strokeLinejoin="round" opacity="0.85" />
            <path d="M4 22 L16 28 L28 22"
                  stroke={active.color} strokeWidth="1.4" fill="none"
